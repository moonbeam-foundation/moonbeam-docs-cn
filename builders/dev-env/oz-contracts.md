...
我们从[Contract Wizard](https://docs.openzeppelin.com/contracts/5.x/wizard)中抽取了这个ERC20代币智能合约，并设置预先铸造1000枚代币，激活`Mintable`功能。

![Getting Started with Remix](/images/builders/ethereum/dev-env/openzeppelin/contracts/oz-contracts-1.webp)
...
![Compile ERC-20 Contract with Remix](/images/builders/ethereum/dev-env/openzeppelin/contracts/oz-contracts-2.webp)
...
![Deploy ERC-20 Contract with Remix](/images/builders/ethereum/dev-env/openzeppelin/contracts/oz-contracts-3.webp)
...
我们从[Contract Wizard](https://docs.openzeppelin.com/contracts/5.x/wizard)中抽取了这个ERC721代币智能合约，将`Base URI`设为`Test`，并激活`Mintable`、`Burnable`以及`Enumerable`功能。
...
![Deploy ERC-721 Contract with Remix](/images/builders/ethereum/dev-env/openzeppelin/contracts/oz-contracts-4.webp)
...
我们从[Contract Wizard](https://docs.openzeppelin.com/contracts/5.x/wizard){target=\_blank}中抽取了这个ERC-1155代币智能合约，设置为无`Base URI`，并激活`Pausable`功能。我们对constructor函数进行了修改，可同时铸造同质化和非同质化代币。
...
![Deploy ERC-1155 Contract with Remix](/images/builders/ethereum/dev-env/openzeppelin/contracts/oz-contracts-5.webp)
