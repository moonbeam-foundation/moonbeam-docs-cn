...
对于Moonbeam和Moonriver，您也可以选择在Ledger Live上使用专用的[Moonbeam app](/tokens/connect/ledger/moonbeam/)或[Moonriver app](/tokens/connect/ledger/moonriver/)，此方式无需设置chain ID即可连接至正确的网络。请注意您只能使用Moonbeam app连接至Moonbeam网络，而Moonriver app只能用于连接Moonriver网络。这些专用app无法用于其他基于Moonbeam的网络。
