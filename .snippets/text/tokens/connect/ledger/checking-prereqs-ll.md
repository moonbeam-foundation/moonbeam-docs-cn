自2022年11月29日起，Moonbeam和Ledger Live已完成集成，允许用户直接在Ledger Live使用Ledger设备发送和接收GLMR Token。通过此次集成，您无需将Ledger连接至MetaMask。如果您想通过此方法操作，请直接跳转至本教程的[使用Ledger Live发送&接收GLMR](#use-ledger-live)部分。
