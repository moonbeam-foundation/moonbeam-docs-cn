...
您也可以选择使用Ethereum app连接至Moonbeam。使用Moonbeam app和Ethereum app的主要区别在于当您使用Etheruem app时必须指定chain ID，Moonbeam的chain ID为1284。如果您想要在Moonbeam使用Ethereum app，您可以查看[使用Ledger和Ethereum App与Moonbeam交互](/tokens/connect/ledger/ethereum)的教程。
